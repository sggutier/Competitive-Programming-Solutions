...
void memo( int pos, int masc ) {
	...
	if( pos<8 || res[pos-8]<=0  ) {
		memo(  pos+1,  (  (masc<<1)  & (  ~(1<<17) )  )+1  ) ;
		minS[pos][masc] = min( minS[pos][masc],  minS[pos+1][(  (masc<<1)  & (  ~(1<<17) )  )+1] +1 )     ;
	}
    ...
    if( pos<8 || res[pos-8]<=0  ) {
		memo(  pos+1,  (  (masc<<1)  & (  ~(1<<17) )  )  ) ;
        minS[pos][masc] = min( minS[pos][masc],  minS[pos+1][(  (masc<<1)  & (  ~(1<<17) )  )]  )    ;
	}
